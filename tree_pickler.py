...
# pickle (object serialization): saving  binary representation of an object
# to file for loading and using later
# example: saving a trained model for inference/prediction later
# in another python process, possibly running a diff machine (server)
...
# example: a web app that loads the trained model up for inferene/prediction
